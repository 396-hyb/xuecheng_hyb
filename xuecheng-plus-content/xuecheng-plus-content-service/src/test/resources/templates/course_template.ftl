...
<div class="article-banner">
    ...
    <div class="banner-info">
        <div class="banner-left">
            <p>${model.courseBase.mtName!"课程大分类"}<span>\ ${model.courseBase.stName!"课程小分类"}</span></p>
    ...
    <div class="popup-box">
        ...
        <div class="popup-pay-box">
            ...
            <div class="content">
                ...
                <div class="info">
                    <p class="info-tit">${model.courseBase.name}<span>课程有效期:${model.courseBase.validDays!"0"}天</span></p>
